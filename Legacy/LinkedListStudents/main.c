...
int main() {
    ...
    if (sc == SUCCESS) {
        ...
        while (choice != 0) {
            ...
            case 3: { // check whether list is empty or not
            ...
            case 4: { // for searching the record int the list
                key k;
                ...
                if (searchKey(list, &pre, &cur, k) == FOUND) {
                    ...
                    printf("  |             |               |                       |    "
                           "           |\n");
                    printf("  |   Roll No   |   Sub Codes   |    Name Of Student    |    "
                           " Marks     |\n");
                    printf("  "
                           "|_____________|_______________|_______________________|______"
                           "_________|\n");
                    printf("  |             |               |                       |    "
                           "           |\n");
                    printData(cur->s);
                    ...
                    printf("\nThe Key Is Not Found In The Student Records OR List Is "
                           "Empty\n\a");
                }
                break;
            }
            case 5: { // for calculating nuber of records in the list
                printf("\nNumber Of Records In List Are :%d\n", getNumRecords(list));
                break;
            }
            case 6: {
                // for calculating number of students having max marks in perticular
                // subject
            ...
            case 7: { // unique list print
                uniqueList(list);
                printf("\nUnique List Is As Follows\n");
                printList(list);
                break;
            }
            case 8: { // for printing the list
                printList(list);
                break;
            }
            case 9: {
            ...
            case 10: { // take the union of the two lists
                printf("\n\tSelect 1st List\n");
                list1 = createList();
                printf("\n\tSelect 2nd List\n");
                list2 = createList();
...
void printMenuShort() {
    ...
    printf("  |  5.Size           6.Max Marks   |  7.Unique           8.Print    "
           "   |\n");
    printf("  |  9.Change List    10.Union      |  11.InterSection    "
           "12.Symmetric  |\n");
