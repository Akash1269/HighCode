...
student scanData() {
  ...
  printf("sub code:");
  getchar();
  fgets(s.k.sub_code, CODE_SIZE, stdin);
  s.k.sub_code[strcspn(s.k.sub_code, "\n")] = '\0';
...
void printList(node *ptr) {
  if (isEmpty(ptr) == SUCCESS)
    ...
    printf("  |   Roll No   |   Sub Codes   |    Name Of Student    |     "
           "Marks     |\n");
    printf("  "
           "|_____________|_______________|_______________________|____________"
           "___|\n");
    printf("  |             |               |                       |          "
           "     |\n");
    while (ptr != NULL) {
